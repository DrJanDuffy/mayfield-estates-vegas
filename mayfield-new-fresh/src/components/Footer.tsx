    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>123 Mayfield Drive</p>
              <p>Las Vegas, NV 89134</p>
              <p>Phone: (702) 555-0123</p>
              <p>Email: info@mayfieldestates.com</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cma" className="hover:text-gray-300">
                  Get Home Value
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p>&copy; {new Date().getFullYear()} Mayfield Estates. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
